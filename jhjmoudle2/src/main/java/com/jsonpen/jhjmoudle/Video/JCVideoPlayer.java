...
import com.jsonpen.jhjmoudle.Video.JCResizeTextureView;
import com.jsonpen.jhjmoudle.Video.Utils;
...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, View.OnTouchListener, SeekBar.OnSeekBarChangeListener, JCMediaManager.JCMediaPlayerListener, TextureView.SurfaceTextureListener {
    ...
    protected static com.jsonpen.jhjmoudle.Video.JCBuriedPoint JC_BURIED_POINT;
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.start) {
            ...
            if (mIfCurrentIsFullscreen) {
                ...
                JCFullScreenActivity.startActivityFromNormal(getContext(), mCurrentState, mUrl, com.jsonpen.jhjmoudle.Video.JCVideoPlayer.this.getClass(), this.mObjects);
            }

...
/**
 * databinding的adapter的基类
 */
public abstract class RecyclerBaseAdapter<T, sv extends ViewDataBinding> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//    public sv bindView;
    ...
    protected abstract void initClickListener(RecyclerViewHolder position, int i);
